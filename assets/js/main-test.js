    ...
    $("#a-case_study-la-viewing_info, #a-resume-work-la-viewing_info").click(
      function () {
        ...
        if (window_width > 1024)  {
          ...
          // is passed on.
          new_url_string = "http://chriscjamison.com/la/la-desktop.htm";
          ...
          // The URL of page a visitor on a desktop browser will view http://www.leadersacademy.com 
          // is passed on.
          new_url_string = "http://leadersacademy.com/";
 ...
 */
  ...
  if (url_string === "/start_a_conversation.htm")  {
    ...
    if (window_width > 1024)  {
      // A String variable which will hold the selector which refers to the Submit button 
      // is initialized.
      var submit_button_selector = "";

      // An Object variable which will hold the jQuery object which refers to the Submit 
      // button is initialized.
      var submit_button_element = {};

      // The CSS selector which refers to the Submit button is passed on.
      submit_button_selector = "#input-conversation-submit";

      // The jQuery which refers to the Submit button is passed on.
      submit_button_element = $(submit_button_selector);

      // A String variable which will hold the updated copy is initialized.
      var submit_button_copy = "";

      // The updated copy is passed on.
      submit_button_copy = "Click to send your message";

      // The Submit button's copy is now updated.
      $(submit_button_element).prop("value", submit_button_copy);
    }
 ...
 */
  ...
  if (url_string === "/" || url_string === "/index.htm")  {
    ...
    } else if (window_width >= 1366 && window_width <= 1600) {
      // A String 
    }
  }
